...
export function SendPaymentScreen({ onNavigate }: SendPaymentScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="sticky top-0 bg-background/80 backdrop-blur-md z-30 px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="flex-1 text-xl font-bold text-foreground">Send Payment</h1>
      </div>
        ...
        <div className="bg-card rounded-2xl p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="font-semibold text-foreground">
              {(Number(amount) + 0.17).toFixed(2)} {selectedToken.symbol}
            </span>
          </div>
        </div>
      </div>
